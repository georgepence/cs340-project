...
insert into `Bookings` values (9, '2021-08-29', '2021-08-30', 4, 3, NULL, NULL);
insert into `Bookings` values (10, '2021-08-29', '2021-08-31', 1, 1, NULL, NULL);
insert into `Bookings` values (11, '2021-08-30', '2021-08-31', 1, 2, NULL, NULL);
insert into `Bookings` values (12, '2021-08-30', '2021-09-01', 4, 4, NULL, NULL);
insert into `Bookings` values (13, '2021-08-31', '2021-09-01', 3, 3, NULL, NULL);
insert into `Bookings` values (14, '2021-08-31', '2021-09-02', 1, 1, NULL, NULL);
insert into `Bookings` values (15, '2021-09-01', '2021-09-02', 1, 2, NULL, NULL);
insert into `Bookings` values (16, '2021-09-01', '2021-09-03', 1, 4, NULL, NULL);
insert into `Bookings` values (17, '2021-09-02', '2021-09-03', 3, 3, NULL, NULL);
insert into `Bookings` values (18, '2021-09-02', '2021-09-04', 1, 1, NULL, NULL);
insert into `Bookings` values (19, '2021-09-03', '2021-09-04', 1, 2, NULL, NULL);
insert into `Bookings` values (20, '2021-09-03', '2021-09-05', 1, 4, NULL, NULL);
insert into `Bookings` values (21, '2021-09-04', '2021-09-05', 4, 3, NULL, NULL);
insert into `Bookings` values (22, '2021-09-04', '2021-09-06', 1, 1, NULL, NULL);
insert into `Bookings` values (23, '2021-09-05', '2021-09-06', 1, 2, NULL, NULL);
